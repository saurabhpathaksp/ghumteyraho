      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Lucknow, Uttar Pradesh, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:saurabhpathak1905@gmail.com" className="d-block" >saurabhpathak1905@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:9559123524" className="d-block" >9559123524</a>
          </div>
        ...
        <p className="text-light">   @ 2024. Saurabh Pathak All rights reserved </p> 
        </Col>
        </Row>
